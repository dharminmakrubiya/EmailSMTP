...
class Team_Element_Shortcode_Block {
	...
	public function __construct() {
		...
		add_action( 'wp_enqueue_scripts', array( $this, 'sptp_block_enqueue_scripts' ) );
	...
	public function sptp_block_enqueue_scripts() {
		...
		wp_enqueue_script( SPT_PLUGIN_SLUG, SPT_PLUGIN_ROOT . 'src/Frontend/js/script.js', array( 'jquery' ), SPT_PLUGIN_VERSION, true );
	}
