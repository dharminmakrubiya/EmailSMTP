		...
		public function render() {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'tablet_icon'         => '<i class="fa fa-tablet-alt"></i>',
			...
			if ( ! empty( $args['all'] ) ) {
				...
				echo '<input type="number" name="' . esc_attr( $this->field_name( '[all]' ) ) . '" value="' . esc_attr( $value['all'] ) . '"' . wp_kses_post( $placeholder ) . ' class="spf-number" />';
