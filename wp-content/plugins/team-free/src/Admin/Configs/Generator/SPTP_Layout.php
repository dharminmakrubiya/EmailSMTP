			...
			array(
				'fields' => array(
					...
					array(
						...
						'options' => array(
							'carousel'        => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/carousel.svg',
								'option_name' => __( 'Carousel', 'team-free' ),

							),
							'grid'            => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/grid.svg',
								'option_name' => __( 'Grid', 'team-free' ),

							),
							'list'            => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/list.svg',
								'option_name' => __( 'List', 'team-free' ),

							),
							'filter'          => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/isotope.svg',
								'option_name' => __( 'Isotope', 'team-free' ),
								'pro_only'    => true,
							),
							'mosaic'          => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/mosaic.svg',
								'option_name' => __( 'Mosaic', 'team-free' ),
								'pro_only'    => true,
							),
							'inline'          => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/inline.svg',
								'option_name' => __( 'Inline', 'team-free' ),
								'pro_only'    => true,
							),
							'table'           => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/table.svg',
								'option_name' => __( 'Table', 'team-free' ),
								'pro_only'    => true,
							),
							'thumbnail-pager' => array(
								'image'       => SPT_PLUGIN_ROOT . 'src/Admin/img/thumbnails-pager.svg',
								'option_name' => __( 'Thumbnails Pager', 'team-free' ),
								'pro_only'    => true,
							),
						),
						'default' => 'carousel',
