			...
			array(
				'fields' => array(
					...
					array(
						'type'    => 'notice',
						'style'   => 'success',
						'content' => __( 'To unlock the Member Information, Additional Custom Fields, Skills, and Photo Gallery, <a href="https://shapedplugin.com/plugin/wp-team-pro/?ref=1"><b>Upgrade To Pro!</b></a>', 'team-free' ),
					),
					array(
						'type'    => 'subheading',
					...
					array(
						...
						'fields'       => array(
							...
							array(
								...
								'type'        => 'select',
								'options'     => array(
									'text'   => esc_html__( 'Text', 'team-free' ),
									'number' => esc_html__( 'Number', 'team-free' ),
									'email'  => esc_html__( 'Email', 'team-free' ),
									'link'   => esc_html__( 'Link', 'team-free' ),
									'date'   => esc_html__( 'Date', 'team-free' ),
								),
