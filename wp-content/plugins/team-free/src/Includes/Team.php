...
class Team {
	...
	public function add_generator_links( $links ) {
		...
		$links[] = '<a href="https://shapedplugin.com/plugin/wp-team-pro/?ref=1" style="color: #35b747; font-weight: 700;">' . __( 'Go Premium!', 'team-free' ) . '</a>';
	...
	private function define_admin_hooks() {
		...
		$plugin_premium = new Team_Premium( SPT_PLUGIN_SLUG, SPT_PLUGIN_VERSION );
		$plugin_help    = new Help_Page( SPT_PLUGIN_SLUG, SPT_PLUGIN_VERSION );
