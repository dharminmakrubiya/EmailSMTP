    ...
    ?>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                   <?php 
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="real_image_radius" value="<?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0 ?>" class="wpm-form-input" id="wpm_real_image_radius" />
                      </td>
                    </tr>
                    <tr>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <?php                                         
                                                                    ?></td>
                      <td>
                        <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34] : $allStyle[7] ?>;">
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="hover_bottom_border_color" id="wpm_hover_bottom_border_color" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(220, 0, 90, 0.8)' ?>">
                      </td>
                    </tr>
                  </table>
                </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_top" id="wpm_member_margin_top" type="number" min="0"
                          value="<?php echo (isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:15;?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0"
                          value="<?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:5;?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0"
                          value="<?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:10;?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      ...
                      <td>
                          ...
                          <input type="checkbox" name="social_activation" id="wpm_social_activation" value="1" <?php echo (!isset($allStyle[35]) || (isset($allStyle[35]) && $allStyle[35])) ? 'checked' : '' ?>>
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_13_pic img {
          ...
          height: auto;
          float: left;
          -webkit-border-radius: <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0 ?>%;
          -o-border-radius: <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0 ?>%;
          -moz-border-radius: <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0 ?>%;
          -ms-border-radius: <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0 ?>%;
          border-radius: <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0 ?>%;
        }
        ...
        .wpm_6310_team_style_13_title {
          ...
          margin-top: <?php echo (isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:15;?>px;
          margin-bottom: <?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:5;?>px;
          float: left;
          width: 100%;
        }
        ...
        .wpm_6310_team_style_13:hover {
          box-shadow: 0 -5px <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(220, 0, 90, 0.8)' ?> inset;
          background-color: <?php echo (isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34] : '' ?>;
        }

        ul.wpm_6310_team_style_13_social {
          display: <?php echo (!isset($allStyle[35]) || (isset($allStyle[35]) && $allStyle[35])) ? 'block':'none'?>;
          list-style: none;
          padding: 5px 0 2px;
        ...
        .wpm-6310-owl-stage-outer {
          padding-top: <?php echo ($allStyle[3] * 2) ?>px;
          padding-bottom: <?php echo ($allStyle[3] * 2) ?>px;
        }
      </style>
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_13<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_13_pic">
                    <img src="<?php echo ($value['image'] ? $value['image'] : $value['hover_image']) ?>" data-6310-hover-image="<?php echo $value['hover_image'] ?>" class="img-responsive <?php echo $allStyle[5] ?>" alt="<?php echo $value['name'] ?>" >
                  </div>
