    ...
    <div class="wpm-6310-sm">
                            ...
                            <div class="wpm-col-6">
                                <table class="table table-responsive wpm_6310_admin_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="box_background" id="wpm_box_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(0, 153, 153, 1)' ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '' ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="0" name="box_shadow_width" value="<?php echo (isset($allStyle[8]) && $allStyle[8] !== '') ? $allStyle[8] : 0 ?>" class="wpm-form-input" step="1" id="wpm_box_shadow_width" />
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="wpm-col-6">
                                <table class="table table-responsive wpm_6310_admin_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo (isset($allSlider[42]) && $allSlider[42] !== 0) ? $allSlider[42] : 0; ?>" class="wpm-form-input" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="wpm-col-6">
                                <table class="table table-responsive wpm_6310_admin_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 4; ?>" class="wpm-form-input" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
        ...
        <style type="text/css">
            ...
            .wpm_6310_team_style_29 {
                ...
                position: relative;
                height: 100%;
                background-color: <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : '#009999' ?>;
            }

            .wpm_6310_team_style_29:hover {
                background-color: <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '' ?>;
            }
            ...
            .wpm_6310_team_style_29_designation {
                ...
                float: left;
                width: 100%;
                margin-top: <?php echo (isset($allSlider[51]) && $allSlider[51] !== '') ? $allSlider[51] : 10; ?>px;
                margin-bottom: <?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 4; ?>px;
            }
