                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="image_border_width" value="<?php echo (isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34] : 30 ?>"
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="image_border_color" id="wpm_image_border_color"
                          ...
                          value="<?php echo (isset($allStyle[35]) && $allStyle[35] !== '') ? $allStyle[35] : '#e6e5e5' ?>">
                      </td>
                    </tr>  
                    <tr>
                      ...
                      <td>
                        <input type="text" name="image_border_color_2" id="wpm_image_border_color_2"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb"
                          value="<?php echo (isset($allStyle[36]) && $allStyle[36] !== '') ? $allStyle[36] : '#37b0f1' ?>">
                      </td>
                    </tr>                    
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="name_border_width" value="<?php echo (isset($allStyle[37]) && $allStyle[37] !== '') ? $allStyle[37]: 50;?>"
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="name_border_color" id="wpm_name_border_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb" 
                          value="<?php echo (isset($allStyle[38]) && $allStyle[38] !== '') ? $allStyle[38]: "#222";?>">
                      </td>
                    </tr>
                  </table>
                </div>
...
.wpm_6310_team_style_32_img:after{
    ...
    height: 100%;
    border-radius: 50%;
    border: <?php echo $allStyle[34] ?>px solid <?php echo $allStyle[35] ?>;
    position: absolute;
    top: 0;
    left: 0;
...
.wpm_6310_team_style_32_img:after{
    border-color: <?php echo $allStyle[36] ?> <?php echo $allStyle[35] ?> <?php echo $allStyle[35] ?> <?php echo $allStyle[36] ?>;
    z-index: 1;
...
.wpm_6310_team_style_32_title:after {
    content: "";
    width: <?php echo $allStyle[37] ?>px;
    height: 2px;
    background: <?php echo $allStyle[38] ?>;
    margin: 0 auto;
    position: absolute;
    bottom: 0;
    left: 0;
...
.wpm_6310_team_style_32:hover .wpm_6310_team_style_32_title:after{
    width: <?php echo $allStyle[37]  + 20 ?>px;
}
 .wpm_6310_team_style_32_designation{
    ...
    margin-top: <?php echo $allSlider[51] ?>px;
    margin-bottom: <?php echo $allSlider[52] ?>px;
}
