  ...
  <div class="wpm-6310-sm">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="image_hover_background" id="wpm_image_hover_background" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $allStyle[7] ?>">
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input type="text" name="box_background" id="wpm_box_background" class="wpm-form-input wpm_6310_color_picker"  data-format="rgb" value="<?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(255, 255, 255, 1)' ?>">
                    </td>
                  </tr>
                  <tr>
                    ...
                    <?php
                                                                ?></td>
                    <td>
                      <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 'rgba(255, 255, 255, 1)' ?>">
                    </td>
                  </tr>
                  <tr>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_top" id="wpm_member_margin_top" type="number" min="0" value="<?php echo (isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41] : 15; ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 20; ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 23; ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <style type="text/css">
      ...
      .wpm_6310_team_style_19 {
        ...
        position: relative;
        height: 100%;
        background-color: <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : '#FFF' ?>;
      }

      .wpm_6310_team_style_19:hover {
        background-color: <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '#FFF' ?>;
      }
      ...
      ul.wpm_6310_team_style_19_social {
        display: <?php echo (!isset($allStyle[34]) || (isset($allStyle[34]) && $allStyle[34])) ? 'block' : 'none' ?>;
        padding: 0 0 18px 0;
        margin: 0;
        list-style: none;
        position: absolute;
      ...
      .wpm_6310_team_style_19_title {
        ...
        margin-bottom: <?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 20; ?>px;
      }
      ...
      .wpm_6310_team_style_19_title:after {
        ...
        bottom: 0px;
        background: <?php echo $allStyle[4] ?>;
        outline: 4px solid <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : '#FFF' ?>;
      }
      
      .wpm_6310_team_style_19:hover .wpm_6310_team_style_19_title:after
    {
      background: <?php echo $allStyle[4] ?>;
      outline: 4px solid <?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '#FFF' ?>;
      }
      ...
      .wpm_6310_team_style_19:hover .wpm_6310_team_style_19_title:before
    {
      ...
      .wpm_6310_team_style_19_designation {
        ...
        margin-bottom: <?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 23; ?>px;
      }   
