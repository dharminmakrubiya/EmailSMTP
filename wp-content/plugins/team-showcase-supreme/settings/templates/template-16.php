  ...
  <div class="wpm-6310-sm">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="image_hover_overlay" id="wpm_image_hover_overlay" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[4] ?>">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <?php
                                                                ?></td>
                    <td>
                      <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : '' ?>">
                    </td>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 5; ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 15; ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <style type="text/css">
      ...
      .wpm_6310_team_style_16:hover {
        background-color: <?php echo (isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : '' ?>;
      }
      ...
      .wpm_6310_team_style_16_social_team {
        ...
        background: <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[4] ?>;
      }
      ...
      .wpm_6310_team_style_16_social_team:before {
        ...
        -webkit-border-top-left-radius: <?php echo $allStyle[2] ?>px;
        -o-border-top-left-radius: <?php echo $allStyle[2] ?>px;
        -moz-border-top-left-radius: <?php echo $allStyle[2] ?>px;
        -ms-border-top-left-radius: <?php echo $allStyle[2] ?>px;
        border-top-left-radius: <?php echo $allStyle[2] ?>px;
      }
      ...
      .wpm_6310_team_style_16_designation {
        ...
        margin-bottom: <?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 15; ?>px;
        display: block;
