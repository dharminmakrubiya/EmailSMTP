  ...
  <div class="wpm-6310-sm">
                ...
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <?php
                                                                ?></td>
                    <td>
                      <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 'rgba(255, 255, 255, 1)' ?>">
                    </td>
                  </tr>
                  <tr>
    ...
    <style type="text/css">
      ...
      .wpm_6310_team_style_20 {
        ...
        border-right: none;
        height: 100%;
        background-color: <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'transparent' ?>;
      }
