    ...
    ?>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[7] ?>">
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0"
                          value="<?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:0;?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_margin_top" value="<?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 10; ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                      </td>
                    </tr>
                    <tr class="social_act_field">
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_09:hover {
          background-color: <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : '' ?>;
        }
        ...
        .wpm_6310_team_style_09_title {
          float: left;
          width: 100%;
          margin-top: <?php echo (isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:20;?>px;
        ...
        .wpm_6310_team_style_09_social {
          ...
          float: left;
          width: calc(100% + 20px);
          padding: <?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61]:10;?>px 0 <?php echo (isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62]:10;?>px;
          margin: 0;
          margin-left: -10px;
          list-style: none;
