    ...
    ?>
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_02:hover .wpm_6310_team_style_02_pic:after {
          opacity: 0.85;
          height: <?php echo isset($allStyle[31]) ? $allStyle[31] : 60 ?>%;
          top: <?php echo isset($allStyle[31]) ? (100 - $allStyle[31]) : 40 ?>%;
        }
        ...
        .wpm_6310_team_style_02_team_content {
          ...
          top: <?php echo isset($allStyle[31]) ? (100 - $allStyle[31]) : '50' ?>%;
          display: flex;
          flex-direction: column;
          justify-content: center;
          height: <?php echo isset($allStyle[31]) ? $allStyle[31] : '45' ?>%;
        }
        ...
        ul.wpm_6310_team_style_02_social {
          ...
          width: 100%;
          margin: 0;
          margin-top: <?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61]:15;?>px;
