        ...
        ?>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:3;?>" class="wpm-form-input" />
                                            </td>
                                            </tr>
                                    </table>
                                </div>
            ...
            <style type="text/css">
                ...
                .wpm_6310_team_style_24_title {
                    ...
                    margin-bottom: <?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:3;?>px;
                }
                            ...
                            <div class="wpm-6310-col-<?php echo $desktop_row; ?>">
                                <div class="wpm_6310_team_style_24<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                                    ...
                                    <div class="wpm_6310_team_style_24_team_content">
                                        ...
                                        <?php echo wpm_6310_read_more($readMoreActive, $template_id, $allSlider, $cls, $attr2, 0); ?>
                                    </div>
                            </div>
                </div>
        <?php
