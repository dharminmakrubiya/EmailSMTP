    ...
    ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0"
                          value="<?php echo isset($allSlider[42]) ? $allSlider[42]:0;?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_margin_bottom" value="<?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 0; ?>" class="wpm-form-input" id="wpm_social_margin_bottom" />
                      </td>
                    </tr>
                  </table>
                </div>
      ...
      <style type="text/css">
        ...
        ul.wpm_6310_team_style_11_social {
          ...
          list-style: none;
          text-align: center;
          margin-top: <?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 20 ?>px;
          ...
          ?>
              <div class="wpm-6310-col-<?php echo $desktop_row; ?>">
                <div<?php echo $link_type; ?>>
                  <div class="">
                    <img src="<?php echo ($value['image'] ? $value['image'] : $value['hover_image']) ?>" data-6310-hover-image="<?php echo $value['hover_image'] ?>" class="wpm-image-responsive" alt="Team Showcase" >
                    <?php
                    if (trim($value['name'])) {
