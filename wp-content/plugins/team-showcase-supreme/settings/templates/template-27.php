  ...
  <div class="wpm-6310-sm">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                   ...
                   <tr class="social_act_field">
                    ...
                    <td>
                      <input type="number" min="0" name="social_margin_top" value="<?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 20; ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                    </td>
                  </tr>
                   <tr class="social_act_field">
    ...
    <style type="text/css">
      ...
      .wpm_6310_team_style_27_social {
        ...
        position: absolute;
        bottom: <?php echo ($allStyle[18] + $allStyle[24] + 70) ?>px;
        left: 0;
        opacity: 0;
        z-index: 1;
        transition: all 1s ease 0s;
        padding-top: <?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 20; ?>px;
        padding-bottom: <?php echo (isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 0; ?>px;
      }
      ...
      .wpm_6310_team_style_27:hover .wpm-custom-fields-<?php echo $styleId ?> {
        /* opacity: 1;
          height: 100%;
          transform: scale(1); */
      }
      ...
      .wpm_6310_team_style_27:hover .wpm_6310_team_style_<?php echo $styleId ?>_description {
        /* opacity: 1;
          height: 100%;
          transform: scale(1); */
      }
