    ...
    ?>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="member_bg_color" id="wpm_member_bg_color" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[13]) && $allStyle[13] !== '') ? $allStyle[13] : 'rgba(31, 125, 207, 1)' ?>">
                      </td>
                    </tr>
                    <tr>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="designation_bg_color" id="wpm_designation_bg_color" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo (isset($allStyle[14]) && $allStyle[14] !== '') ? $allStyle[14] : 'rgba(31, 125, 207, 1)' ?>">
                      </td>
                    </tr>
                    <tr>
                      <td><b>Font Weight</b><?php                     
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_04_designation {
          ...
          background-color: <?php echo (isset($allStyle[14]) && $allStyle[14] !== '') ? $allStyle[14] : 'rgba(31, 125, 207, 1)' ?>;
        }
        ...
        .wpm_6310_team_style_04_title {
          ...
          background-color: <?php echo (isset($allStyle[13]) && $allStyle[13] !== '') ? $allStyle[13] : 'rgba(31, 125, 207, 1)' ?>;
        }
