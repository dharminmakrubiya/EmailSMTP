        ...
        ?>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[10] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo (isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:20;?>" class="wpm-form-input" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo (isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:8;?>" class="wpm-form-input" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:28;?>" class="wpm-form-input" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
            ...
            <style type="text/css">
                ...
                .wpm_6310_team_style_18 {
                    ...
                    position: relative;
                    height: 100%;
                    background-color: <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[10] ?>;
                }
                ...
                .wpm_6310_team_style_18_title {
                    ...
                    padding-left: 10px;
                    padding-right: 10px;
                    padding-top: <?php echo (isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:20;?>px;
                    padding-bottom: 10px;
                ...
                .wpm_6310_team_style_18_designation {
                    ...
                    margin-bottom: <?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:28;?>px;
                }
