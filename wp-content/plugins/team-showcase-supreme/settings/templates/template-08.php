      ...
      ?>
                        ...
                        <div class="wpm-col-6">
                           <table class="table table-responsive wpm_6310_admin_table">
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" name="member_stoke_1_color" id="member_stoke_1_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo (isset($allStyle[34]) && $allStyle[34] != '') ? $allStyle[34] : 'rgb(55, 207, 215)' ?>">
                                 </td>
                              </tr>  
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" name="member_stoke_2_color" id="member_stoke_2_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo (isset($allStyle[35]) && $allStyle[35] !== '') ? $allStyle[35] : 'rgb(244, 54, 98)' ?>">
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" name="member_stoke_1_hover_color" id="member_stoke_1_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo (isset($allStyle[36]) && $allStyle[36] !== '') ? $allStyle[36] : 'rgb(244, 54, 98)' ?>">
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" name="member_stoke_2_hover_color" id="member_stoke_2_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo (isset($allStyle[37]) && $allStyle[37] !== '') ? $allStyle[37] : 'rgb(55, 207, 215)' ?>">
                                 </td>
                              </tr>
                              <tr>
                                 <td><b>Margin Top</b>
         ...
         .wpm_6310_tabs_panel_preview .wpm-6310-row {
            ...
            .wpm_6310_team_style_08_border {
               ...
               float: left;
               width: 100px;
               border-bottom: 3px solid <?php echo (isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34]:'rgb(55, 207, 215)'; ?>;
               display: block;
               margin: 0;
               transition: all 0.3s ease 0s;
            ...
            .wpm_6310_team_style_08_border:after {
               ...
               position: relative;
               top: 3px;
               border-bottom: 3px solid <?php echo (isset($allStyle[35]) && $allStyle[35] !== '') ? $allStyle[35]:'rgb(244, 54, 98)'; ?>;
               margin: auto;
            }
            ...
            .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_title {
               color: <?php echo (isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[12] ?>;
            }
            ...
            .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_border {
               border-color: <?php echo (isset($allStyle[36]) && $allStyle[36] !== '') ? $allStyle[36]:'rgb(244, 54, 98)'; ?>;
            }

            .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_border:after {
               border-color: <?php echo (isset($allStyle[37]) && $allStyle[37] !== '') ? $allStyle[37]:'rgb(255, 255, 255)'; ?>;
            }
