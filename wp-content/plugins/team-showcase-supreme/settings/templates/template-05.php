    ...
    ?>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_margin_top" value="<?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 15; ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                      </td>
                    </tr>
                    <tr class="social_act_field">
                      <td>
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_05:hover .wpm_6310_team_style_05_pic:after {
          height: <?php echo (isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 60 ?>%;
          opacity: 0.85;
          top: <?php echo (isset($allStyle[31]) && $allStyle[31] !== '') ? (100 - $allStyle[31]) / 2 : 20 ?>%;
        }
        ...
        .wpm_6310_team_style_05_team_content {
          ...
          top: <?php echo (isset($allStyle[31]) && $allStyle[31] !== '') ? 50 : 32 ?>%;
          transform: <?php echo (isset($allStyle[31]) && $allStyle[31] !== '') ? 'translateY(-50%)' : '' ?>;
        }
        ...
        ul.wpm_6310_team_style_05_social {
          ...
          padding: 0;
          margin: <?php echo (isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61]:15;?>px 0 <?php echo (isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62]:0;?>px;
          list-style: none;
          text-align: center;
          float: left;
          width: 100%;
