...
Team Members - Team with Slide is the best plugins to display unlimited team in Carouse and Grid view. The Team Members - Team with Slide plugin comes with 38+ team design layouts.

== Description ==
https://www.youtube.com/watch?v=XQMLA_F_CYs


[Live Demo](https://www.wpmart.org/team-showcase-supreme-demo/) | [Support](https://wpmart.org/contact/) | [Upgrade to Pro](https://www.wpmart.org/downloads/team-showcase-supreme-pro)

<strong>Team Members with Slider</strong> is a responsive and mobile-friendly WordPress team making plugin that has some amazing features to make an amazing team showcase. Using this plugin, you can display your team members in a different layout like Grids and Sliders. It is very powerful yet lightweight team member plugin which allows you to decorate your team, support, contacts, about us or staff page with ease of customization. You can add, customize and showcase your team with responsive slider. While using this plugin, you’ll find Team Showcase with Slider the faster and simpler way to add and showcase your team member within your webpage.
...
WordPress Team Member with Slider Plugin

= Is the Team Member plugin support Elementor, Gutenberg, Visual Composer and WP Bakery? =

Yes, It’s support all popular WordPresss page builders.

= Is the Team Member plugin support Divi Theme, BeTheme, Avada Theme and Astra Theme? =
...
= Are there any limitations for using the Team Member? =
...
= 3.6 =
* FEATURE – NEW TEMPLATE ADDED
* FEATURE – FIXED JS
* FEATURE – CSS FIXED

= 3.5 =
* FEATURE – SKILLS FIELD ADDED
* FEATURE – FIXED JS
* FEATURE – CSS FIXED

= 3.4 =
* FEATURE – FORM FIELD ADDED
* FEATURE – FIXED JS
* FEATURE – CSS FIXED
...
* FEATURE – FIXED JS
* FEATURE – CSS FIXED
* FEATURE – READ MORE BUTTON ADDED

= 3.1 =
* FEATURE – FIXED JS
* FEATURE – CSS FIXED
* FEATURE – 6 MODAL TEMPLATES ADDED
* FEATURE - PREVIOUS AND NEXT ICON ADDED ON MODAL

= 3.0 =
* FEATURE – FIXED JS
* FEATURE – CSS FIXED
* FEATURE – CATEGORY ADDED
* FEATURE – CONTACT INFORMATION ADDED
...
= 2.2 =
* FEATURE – CSS FIXED
* FEATURE – LOADING ICON CUSTOMIZE OPTION ADDED
